...
import com.britesnow.contactsdemo.dao.BaseDao;
import com.britesnow.contactsdemo.dao.DaoHelper;
import com.britesnow.contactsdemo.dao.DaoRegistry;
import com.britesnow.contactsdemo.dao.IDao;
import com.britesnow.contactsdemo.entity.BaseEntity;
import com.britesnow.contactsdemo.perf.PerfInterceptor;
import com.britesnow.contactsdemo.perf.annotation.ToMonitor;
import com.britesnow.contactsdemo.web.AppAuthService;
...
public class MyAppConfig extends AbstractModule {
    ...
    // --------- For DaoRegistry --------- //
    static private Matcher entityClassMatcher = Matchers.subclassesOf(com.britesnow.contactsdemo.entity.BaseEntity.class).and(Matchers.not(matchAbstractClass()));
